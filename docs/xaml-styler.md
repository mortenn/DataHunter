...
When you open the solution, Visual Studio should also prompt you to install the extension automatically (via `.vsconfig`).
...
This reformats every `*.xaml` file in the repository according to the shared `Settings.XamlStyler` configuration.
